                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        while ($row = mysqli_fetch_assoc($respuesta)) {
                            ...
                            echo "<td> href='eliminar.php?id_enviado=" . $row["id"] . "'><button class='btn btn-sm'>Eliminar</button></a>";
                            echo "<a href='Editar.php?id_enviado=" . $row["id"] . "'><button class='btn btn-sm'>Editar</button></a></td>";
                            echo "</tr>";
                        }
                        ?>
                    </tbody>
